...
dataset = pd.read_csv('datasetFIX_ann_decision_trans.csv')
...
def build_classifier():
    ...
    classifier_kfold.add(Dense(units = 10, kernel_initializer = 'uniform', activation = 'relu', input_dim = 3))
...
# replace 'c' in code below with delta speed value input
new_prediction = classifier.predict(sc.transform(np.array([[a, b, c]])))
